...
ssh ubuntu@$machine "docker-compose -f /home/ubuntu/docker-compose-production.yml up -d --no-build"
if [ $machine == "test" ]; then 
    echo 'run Curl test...'
    Ans= ssh ubuntu@$machine "curl -i https://127.0.0.1:5000/;sleep 20;"
